        ...
        <div className='home-page'>
            <div className='row'>
                <div className="col-md-6">
                    ...
                    <img src="" alt="" />
                    <p className='mb-0' style={{fontSize:"35px"}}>Hello <span style={{fontFamily:"U-bold"}}> Adewale!</span></p>
                ...
                <div className="card-body">
                    <div className="row align-items-center">
                        ...
                        <div className="col-md-6 text-md-end">
                            <button className='btn btn-orange-outline me-3 px-4'> - Withdraw</button>
